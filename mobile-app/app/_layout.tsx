...
function AppNavigator() {
  ...
  // ── Register Expo push token with backend whenever user logs in ──────────
  // This is the only call needed — usePushToken handles permissions, token
  // fetching, and backend registration automatically.
  usePushToken();
