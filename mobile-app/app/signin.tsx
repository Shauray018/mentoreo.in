...
//       setTimeout(() => {
//         console.log("⌨️ Focus OTP input");
//         otpRef.current?.focus();
//       }, 300);
//     } catch (e: any) {
//       console.log("❌ OTP send failed:", e);
//       setError(e.message || "Failed to send OTP");
//       shake();
//     } finally {
//       setLoading(false);
//       console.log("📨 Send OTP finished");
//     }
//   };
...
//       console.log("📡 Connecting Sendbird...");
//       await sdk.connect(user.id);

//       console.log("✅ Sendbird connected");

//       console.log("✏️ Updating nickname...");
...
//           <Text style={styles.tagline}>Learn from those who've been there</Text>
//         </View>
...
//               value={email}
//               onChangeText={(text) => {
//                 console.log("⌨️ Email typing:", text);
//                 setEmail(text);
//               }}
//               autoCapitalize="none"
...
export default function SigninScreen() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      signIn({ ...user, role: user.role as Role, token });
