    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-200">
        <div className="max-w-2xl mx-auto px-6 py-4 flex items-center gap-3">
          <div className="w-8 h-8 rounded bg-black flex items-center justify-center text-white text-sm font-semibold">
            M
          </div>
          <div>
            <div className="text-sm font-semibold leading-none">Mentoreo</div>
            <div className="text-xs text-gray-400 mt-0.5">by Shauray</div>
          </div>
        </div>
      </header>
