...
export default function HeroSection() {
  ...
  const [primaryColor] = useState("#0a0a0a");
  const [secondaryColor] = useState("#fafafa");
  ...
  return (
    <section className="relative min-h-screen bg-orange-400 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        <DitherShader
          src="https://plus.unsplash.com/premium_photo-1730005718798-77677f123d84?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          gridSize={3}
          ditherMode="bayer"
          colorMode="original"
          invert={invert}
      ...
      {/* Content grid */}
      <div className="relative z-10 w-full px-5 sm:px-8 md:px-12 lg:px-20 xl:px-28 pt-20 sm:pt-24 md:pt-16 pb-12 md:pb-20">
        <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">

          {/* Left: copy */}
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">

            {/* Heading — "BROCHURES LIE!" forced onto one line on lg+ */}
            <h1 className="mb-4 sm:mb-5 font-medium leading-[0.95] text-white [-webkit-text-stroke:2px_#111] [text-shadow:4px_4px_0_#111]
              text-[clamp(2rem,8vw,4.5rem)]
              md:text-[clamp(2.5rem,5vw,4.5rem)]
              lg:text-[clamp(3rem,4.5vw,5rem)]">
              <span className="block lg:whitespace-nowrap">BROCHURES LIE!</span>
              <span className="block">SENIORS TELL THE TRUTH</span>
            </h1>

            <p className="mb-7 sm:mb-8 max-w-[480px] text-sm sm:text-base md:text-lg leading-7 text-neutral-300  [-webkit-text-stroke:0.5px_#111]">
            ...
            {/* Download buttons */}
            <div className="mb-8 sm:mb-10 flex flex-wrap justify-center items-center gap-2 sm:gap-3">
              <a
              ...
              >
                <img
                  src="https://cdn.prod.website-files.com/5ffc51a847b677701a3da52b/6a104f4e3c48087d9ed94550_Google.svg"
            ...
            <div className="flex flex-row items-center gap-5 sm:gap-8">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex flex-col">
                  <span className="text-white font-bold text-lg sm:text-xl leading-none">4.8</span>
          ...
          <div className="hidden md:flex items-end justify-center md:justify-end">
            <div className="w-[60%] lg:w-[55%] max-w-[300px] lg:max-w-[340px]">
              <Android
                className="w-full"
                videoSrc="/demo.mp4"
              />
